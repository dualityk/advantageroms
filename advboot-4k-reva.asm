...
BEEP:
	...
	ld a,h			;805a
	or l			;805b
	jp z,post_io		;805c If SP = 0, run POST and new boot
	jp loadsystem		;805f Otherwise, run old loadsystem
...
; Rev BK makes a pass at the hard disk controller down here before POST, but
; that's absent here.

; BLOCK 'version' (start 0x8fe0 end 0x9000)
	defs 26
	defb "REV-A", 0xe1
